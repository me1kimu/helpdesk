...
\begin{titlepage}
    ...
    {\huge\bfseries Informe 3 de proyecto\par}
    \vspace{2cm}
...
\begin{enumerate}
    ...
    \item \textbf{Arquitectura y protocolos:} arquitectura SOA; todo tráfico por conexiones seguras con cifrado vigente; correo autenticado; colas para tareas diferidas.
...
\subsection{Trazabilidad RF\texorpdfstring{$\leftrightarrow$}{↔}Objetivos}
...
\section{Modelo de Datos y Persistencia}
	...
	extbf{Mecanismo de Persistencia:} Para el almacenamiento de los datos se utilizará PostgreSQL como sistema de gestión de bases de datos relacional (RDBMS). Esta elección se debe a la naturaleza estructurada de los datos, la necesidad de mantener la integridad referencial entre entidades como tickets, usuarios y comentarios, y las capacidades transaccionales, de escalabilidad y de extensiones analíticas que ofrece PostgreSQL.
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{img5.jpg}
    \caption{Modelo entidad-relación}
    \label{fig:mer}
\end{figure}
% REVISAR SI LAS IMAGENES DESCRIBEN CORRECTAMENTE EL MODELO DE DATOS
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{img9.jpg}
    \caption{Diagrama lógico con definición de tablas y relaciones}
    \label{fig:logical}
\end{figure}
